...
{
public:
    std::unique_ptr<Link> convertLinkActionToLink(const ::LinkAction *a, const QRectF &linkArea) const;
    ...
    static std::unique_ptr<Link> convertLinkActionToLink(const ::LinkAction *a, DocumentData *parentDoc, const QRectF &linkArea);
